...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'd108', - 704.0, - 5824.0, 270.000, 'd108')
    ...
    set u=BlzCreateUnitWithSkin(p, 'd103', 6208.0, 6144.0, 270.000, 'd103')
    ...
    set u=BlzCreateUnitWithSkin(p, 'd102', 8768.0, - 8256.0, 270.000, 'd102')
    ...
    set u=BlzCreateUnitWithSkin(p, 'd100', 4416.0, 3776.0, 270.000, 'd100')
...
function CreateNeutralPassive takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'd111', - 64.0, 0.0, - 30.671, 'd111')
    set u=BlzCreateUnitWithSkin(p, 'd123', - 6464.0, - 5568.0, 180.000, 'd123')
endfunction
